...
static const char *partype_vals[] = {"", "double", "int", "string", "bool", "object", "xml"};
static int partype_nums[] = {PARTYPE_NONE, PARTYPE_DOUBLE, PARTYPE_INT, PARTYPE_STRING, PARTYPE_BOOL, PARTYPE_OBJECT, PARTYPE_XML};
static const int partype_n = 7;
